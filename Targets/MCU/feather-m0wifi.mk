...
CPU_CPPFLAGS += -DARDUINO_SAMD_ADAFRUIT -DADAFRUIT_FEATHER_M0 -DARDUINO_SAMD_ZERO -DARM_MATH_CM0PLUS
CPU_CPPFLAGS += -DUSB_VID=$(USB_VID) -DUSB_PID=$(USB_PID) -DUSB_MANUFACTURER=\"Adafruit\" -DUSB_PRODUCT=\"Feather\ M0\"
CPU_CPPFLAGS += -DUSBCON -DUSB_CONFIG_POWER=100
