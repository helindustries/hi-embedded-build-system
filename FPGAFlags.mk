...
FPGA_DEBUG_TARGET := $(FPGA_BOARD)
ifeq ($(strip $(FPGA_USE_JTAG)),yes)
	FPGA_JTAG_UPLOAD_TARGET := _jtag
endif

include $(MAKE_INC_PATH)/Targets/FPGA/$(FPGA_BOARD).mk

FPGA_PROJECT_ARGS ?=
FPGA_PROJECT_ARGS += -s $(FPGA_BASE_LIBRARY_PATH)/boards/$(FPGA_BOARD_BASE).vhd
