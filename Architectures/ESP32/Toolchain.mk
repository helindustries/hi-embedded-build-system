...
CPU_TOOLCHAIN_OPTIONS := -DARDUINO_ARCH_ESP32

CC := $(ESP_COMPILERPATH)/xtensa-$(CPU)-elf-gcc
CXX := $(ESP_COMPILERPATH)/xtensa-$(CPU)-elf-g++
GDB := $(ESP_COMPILERPATH)/xtensa-$(CPU)-elf-gdb
AR := $(ESP_COMPILERPATH)/xtensa-$(CPU)-elf-gcc-ar
OBJCOPY := $(ESP_COMPILERPATH)/xtensa-$(CPU)-elf-objcopy
...
ifeq ($(strip $(ESP_SDK_VERSION)),2)
    ...
    ESP_INCLUDE_DIRS += bt/include/esp32c3/include cbor/port/include cmock/CMock/src coap/libcoap/include coap/port/include console driver/$(CPU)/include driver/include
    ESP_INCLUDE_DIRS += efuse/include efuse/$(CPU)/include esp-dl/include esp-dl/include/detect esp-dl/include/image esp-dl/include/layer esp-dl/include/math esp-dl/include/model_zoo
    ...
    ESP_INCLUDE_DIRS += esp_adc_cal/include esp_common/include esp_diagnostics/include esp_eth/include esp_event/include esp_gdbstub/$(CPU) esp_gdbstub/include esp_gdbstub/xtensa
    ...
    ESP_INCLUDE_DIRS += esp_hw_support/include/soc/$(CPU) esp_hw_support/port/$(CPU) esp_hw_support/port/$(CPU)/private_include esp_insights/include esp_ipc/include esp_lcd/include
    ESP_INCLUDE_DIRS += esp_lcd/interface esp_littlefs/include esp_local_ctrl/include esp_netif/include esp_phy/$(CPU)/include esp_phy/include esp_pm/include esp_rainmaker/include
    ESP_INCLUDE_DIRS += esp_ringbuf/include esp_rom/$(CPU) esp_rom/include esp_rom/include/$(CPU) esp_schedule/include esp_serial_slave_link/include esp_system/include
    ...
    ESP_INCLUDE_DIRS += freertos/include/freertos freertos/port/xtensa/include gpio_button/button/include hal/$(CPU)/include hal/include hal/platform_port/include heap/include
    ESP_INCLUDE_DIRS += idf_test/include idf_test/include/$(CPU) ieee802154/include jsmn/include json/cJSON json_generator/upstream json_parser/upstream json_parser/upstream/include
    ...
    ESP_INCLUDE_DIRS += sdmmc/include soc/$(CPU) soc/$(CPU)/include soc/include spi_flash/include spiffs/include tcp_transport/include tcpip_adapter/include ulp/include unity/include
    ...
    ESP_INCLUDE_DIRS += wpa_supplicant/port/include ws2812_led xtensa/$(CPU)/include xtensa/include
    # Old 2.0.7 Includes
	#ESP_INCLUDE_DIRS := esp_hw_support/include esp_hw_support/include/soc esp_hw_support/include/soc/$(CPU) esp_hw_support/port/$(CPU) esp_hw_support/port/$(CPU)/private_include
	#ESP_INCLUDE_DIRS += esp_rom/include esp_rom/include/$(CPU) esp_rom/$(CPU) esp_common/include esp_system/include esp_system/port/soc esp_system/port/public_compat esp_pm/include
	#ESP_INCLUDE_DIRS += esp_ringbuf/include esp_wifi/include esp_event/include esp_netif/include esp_eth/include esp_phy/include esp_phy/$(CPU)/include esp_ipc/include esp_timer/include
	#ESP_INCLUDE_DIRS += esp_gdbstub/include esp_gdbstub/xtensa esp_gdbstub/$(CPU) esp-tls esp-tls/esp-tls-crypto esp_adc_cal/include esp_hid/include esp_local_ctrl/include
	...
	#ESP_INCLUDE_DIRS += esp-sr/include/$(CPU) esp32-camera/driver/include esp32-camera/conversions/include hal/$(CPU)/include hal/include hal/platform_port/include
	...
	#ESP_INCLUDE_DIRS += xtensa/include xtensa/$(CPU)/include driver/include driver/$(CPU)/include efuse/include efuse/$(CPU)/include asio/asio/asio/include asio/port/include
	#ESP_INCLUDE_DIRS += bt/common/osi/include bt/include/$(CPU)/include bt/common/api/include/api bt/common/btc/profile/esp/blufi/include bt/common/btc/profile/esp/include
	...
	#ESP_INCLUDE_DIRS += lwip/include/apps lwip/include/apps/sntp lwip/lwip/src/include lwip/port/esp32/include lwip/port/esp32/include/arch soc/include soc/$(CPU) soc/$(CPU)/include
	...
	#ESP_INCLUDE_DIRS += expat/expat/expat/lib expat/port/include unity/include unity/unity/src fatfs/diskio fatfs/vfs fatfs/src idf_test/include idf_test/include/$(CPU)
    ...
    ESP_INCLUDE_DIRS += esp_hw_support/include/soc esp_hw_support/include/soc/$(CPU) esp_hw_support/dma/include esp_hw_support/ldo/include esp_hw_support/port/$(CPU)
    ESP_INCLUDE_DIRS += esp_hw_support/port/$(CPU)/include heap/include log/include soc/include soc/$(CPU) soc/$(CPU)/include hal/platform_port/include hal/$(CPU)/include
    ESP_INCLUDE_DIRS += hal/include esp_rom/include esp_rom/include/$(CPU) esp_rom/$(CPU) esp_common/include esp_system/include esp_system/port/soc esp_system/port/include/private
    ESP_INCLUDE_DIRS += xtensa/$(CPU)/include xtensa/include xtensa/deprecated_include esp_timer/include lwip/include lwip/include/apps lwip/include/apps/sntp lwip/lwip/src/include
    ...
    ESP_INCLUDE_DIRS += driver/i2c/include driver/touch_sensor/include driver/twai/include driver/touch_sensor/$(CPU)/include esp_pm/include esp_ringbuf/include esp_driver_gpio/include
    ...
    ESP_INCLUDE_DIRS += esp_phy/include esp_phy/$(CPU)/include esp_netif/include mbedtls/port/include mbedtls/mbedtls/include mbedtls/mbedtls/library mbedtls/esp_crt_bundle/include
    ...
    ESP_INCLUDE_DIRS += console esp_vfs_console/include nvs_flash/include spi_flash/include espressif__esp_secure_cert_mgr/include efuse/include efuse/$(CPU)/include
    ...
    ESP_INCLUDE_DIRS += espressif__esp-sr/esp-tts/esp_tts_chinese/include espressif__esp-sr/include/$(CPU) esp_mm/include pthread/include app_trace/include wpa_supplicant/include
    ...
    ESP_INCLUDE_DIRS += esp-tls/esp-tls-crypto esp_adc/include esp_adc/interface esp_adc/$(CPU)/include esp_adc/deprecated/include esp_driver_isp/include esp_driver_cam/include
    ...
    ESP_INCLUDE_DIRS += espcoredump/include/port/xtensa idf_test/include idf_test/include/$(CPU) ieee802154/include mqtt/esp-mqtt/include nvs_sec_provider/include perfmon/include
    ESP_INCLUDE_DIRS += touch_element/include ulp/ulp_common/include ulp/ulp_fsm/include ulp/ulp_fsm/include/$(CPU) usb/include wifi_provisioning/include espressif__esp-nn/include
...
CPPFLAGS ?=
CPPFLAGS += $(OPTIMIZE) $(CPU_OPTIONS) -mlongcalls -MMD -ggdb -gdwarf-4
...
ifeq ($(strip $(ESP_SDK_VERSION)),2)
    ...
    ESP_LD_LIBRARY_DEFS := memory.ld sections.ld $(CPU).rom.ld $(CPU).rom.api.ld $(CPU).rom.libgcc.ld $(CPU).rom.newlib.ld $(CPU).rom.version.ld $(CPU).rom.newlib-time.ld $(CPU).peripherals.ld
else
    ...
    ESP_LD_LIBRARY_SEARCH_DIRS := lib ld qio_qspi
    ESP_LD_LIBRARY_DEFS := memory.ld  sections.ld $(CPU).rom.ld $(CPU).rom.api.ld $(CPU).rom.libgcc.ld $(CPU).rom.newlib.ld $(CPU).rom.version.ld $(CPU).peripherals.ld $(CPU).rom.bt_funcs.ld $(CPU).rom.wdt.ld
endif
endif
...
LIBRARY_PATHS += $(ESP_LD_LIBRARY_SEARCH_DIRS:%="$(ESP_SDK_PATH)/$(CPU_TOOLCHAIN)/%")
