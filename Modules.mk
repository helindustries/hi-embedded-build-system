...
lib%-$(MCU).a.modulecfg:
	$(V)$(MAKE) --directory='$(MODULES_PATH_$*)' --file='$(MAKE_INC_PATH)/ModulesMakefile.mk' 'SUBTARGET_NAME=$*' 'SUBTARGET_PATH=$(MODULES_PATH_$*)' 'MAKE_INC_PATH=$(MAKE_INC_PATH)' 'BUILD_DIR=$(BUILD_DIR)' 'MCU=$(MCU)' 'CFLAGS=$(CFLAGS)' 'CPPFLAGS=$(CPPFLAGS)' 'USE_ARDUINO_MAIN=$(USE_ARDUINO_MAIN)' 'CORE_SKIP_NEW_O=$(CORE_SKIP_NEW_O)' 'CXXFLAGS=$(CXXFLAGS)' 'LDFLAGS=$(LDFLAGS)' 'CC=$(CC)' 'CXX=$(CXX)' 'AR=$(AR)' 'V=$(V)' 'MSG=$(MSG)' cfg
