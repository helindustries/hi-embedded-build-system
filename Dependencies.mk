...
ifeq ($(strip $(VERBOSE)),1)
	$(V)$(VMSG) "Building lib$*-$(MCU).a.dependency"
	$(V)$(VCFGMSG) "NAME:" "$*"
	$(V)$(VCFGMSG) "PATH:" "$(DEPENDENCY_PATH_$*)"
	$(V)$(VCFGMSG) "BUILD_DIR:" "$(BUILD_DIR)/$*"
	$(V)$(VCFGMSG) "MCU_BOARD:" "$(MCU_BOARD)"
	$(V)$(VCFGMSG) "FPGA_BOARD:" "$(FPGA_BOARD)"
	$(V)$(VCFGMSG) "MCU_EXEC_OFFSET:" "$(MCU_EXEC_OFFSET)"
	$(V)$(VCFGMSG) "OPTIMIZE:" "$(OPTIMIZE)"
	$(V)$(VCFGMSG) "VERBOSE:" "$(VERBOSE)"
	$(V)$(VCFGMSG) "DEBUG:" "$(DEBUG)"
	$(V)$(VCFGMSG) "MCU:" "$(MCU)"
	$(V)$(VCFGMSG) "CPU_SPEED:" "$(CPU_SPEED)"
	$(V)$(VCFGMSG) "BUS_SPEED:" "$(BUS_SPEED)"
	$(V)$(VCFGMSG) "CPUARCH:" "$(CPUARCH)"
	$(V)$(VCFGMSG) "CPU_CPPFLAGS:" "$(CPU_CPPFLAGS)"
	$(V)$(VCFGMSG) "CPU_LDFLAGS:" "$(CPU_LDFLAGS)"
	$(V)$(VCFGMSG) "SERIAL_ID:" "$(SERIAL_ID)"
	$(V)$(VCFGMSG) "MCU_BOARD_OPTS:" "$(MCU_BOARD_OPTS)"
	$(V)$(VCFGMSG) "CORE_LIB_PATH:" "$(CORE_LIB_PATH)"
	$(V)$(VCFGMSG) "CORE_PATH:" "$(CORE_PATH)"
else
	@$(MSG) "[LIB]" "$*"
endif
...
%-$(MCU).exec.dependency:
ifeq ($(strip $(VERBOSE)),1)
	$(V)$(VMSG) "Building $*-$(MCU).exec.dependency"
	$(V)$(VCFGMSG) "NAME:" "$*"
	$(V)$(VCFGMSG) "PATH:" "$(DEPENDENCY_PATH_$*)"
	$(V)$(VCFGMSG) "BUILD_DIR:" "$(BUILD_DIR)/$*"
	$(V)$(VCFGMSG) "MCU_BOARD:" "$(MCU_BOARD)"
...
ifeq ($(strip $(VERBOSE)),1)
	$(V)$(VMSG) "Building $*-$(FPGA_BOARD).gateware.dependency"
	$(V)$(VCFGMSG) "NAME:" "$*"
	$(V)$(VCFGMSG) "PATH:" "$(DEPENDENCY_PATH_$*)"
	$(V)$(VCFGMSG) "PATH:" "$(DEPENDENCY_PATH_$*)"
	$(V)$(VCFGMSG) "BUILD_DIR:" "$(BUILD_DIR)/$*"
	...
	$(V)$(VCFGMSG) "VERBOSE:" "$(VERBOSE)"
	$(V)$(VCFGMSG) "DEBUG:" "$(DEBUG)"
	$(V)$(VCFGMSG) "NO_GATEWARE_UPLOAD:" "$(NO_GATEWARE_UPLOAD)"
else
	@$(MSG) "[GATE]" "$*"
endif
...
%.tool.dependency:
ifeq ($(strip $(VERBOSE)),1)
	$(V)$(VMSG) "Building $*.tool.dependency"
	$(V)$(VCFGMSG) "NAME:" "$*"
	$(V)$(VCFGMSG) "PATH:" "$(DEPENDENCY_PATH_$*)"
	$(V)$(VCFGMSG) "BUILD_DIR:" "$(BUILD_DIR)/$*"
	$(V)$(VCFGMSG) "MCU_BOARD:" "$(MCU_BOARD)"
...
%.test.dependency:
ifeq ($(strip $(VERBOSE)),1)
	$(V)$(VMSG) "Building $*.test.dependency"
	$(V)$(VCFGMSG) "NAME:" "$*"
	$(V)$(VCFGMSG) "PATH:" "$(DEPENDENCY_PATH_$*)"
	$(V)$(VCFGMSG) "BUILD_DIR:" "$(BUILD_DIR)/$*"
	$(V)$(VCFGMSG) "MCU_BOARD:" "$(MCU_BOARD)"
...
%.make.dependency:
ifeq ($(strip $(VERBOSE)),1)
	$(V)$(VMSG) "Building $*.make.dependency"
	$(V)$(VCFGMSG) "NAME:" "$*"
	$(V)$(VCFGMSG) "PATH:" "$(DEPENDENCY_PATH_$*)"
	$(V)$(VCFGMSG) "BUILD_DIR:" "$(BUILD_DIR)/$*"
	$(V)$(VCFGMSG) "MCU_BOARD:" "$(MCU_BOARD)"
