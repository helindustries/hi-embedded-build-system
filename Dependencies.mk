...
ifeq ($(strip $(VERBOSE)),1)
	...
	@$(VCFGMSG) "In BUILD_DIR:" "$(BUILD_DIR)/$*"
	...
	$(V)$(MAKE) --directory="$(DEPENDENCY_PATH_$*)" --file="$(DEPENDENCY_PATH_$*)/Makefile" \
 					$(DEPENDENCY_OPTS_$*) 'BUILD_OPTS=$(BUILD_OPTS)' 'VERBOSE=$(VERBOSE)' 'DEBUG=$(DEBUG)' 'IN_CPU_TARGET=$*' \
 					'STARTUP_MAKEFILE=$(STARTUP_MAKEFILE)' 'CPU_BASE_TARGET=$(CPU_BASE_TARGET)' 'IN_BUILD_DIR=$(BUILD_DIR)/$*' \
