...
ifeq ($(strip $(VERBOSE)),1)
	...
	$(V)$(MAKE) --directory="$(DEPENDENCY_PATH_$*)" --file="$(DEPENDENCY_PATH_$*)/Makefile" $(MAKEFLAGS) $(DEPENDENCY_OPTS_$*) 'MAKE_INC_PATH=$(MAKE_INC_PATH)' 'MCU_TARGET=$*' 'BUILD_DIR=$(BUILD_DIR)/$*' 'FPGA_BOARD=$(FPGA_BOARD)' 'VERBOSE=$(VERBOSE)' 'DEBUG=$(DEBUG)' 'NO_GATEWARE_UPLOAD=$(NO_GATEWARE_UPLOAD)' 'NO_GATEWARE_DEPS=$(NO_GATEWARE_DEPS)' 'NO_TOOLS_DEPS=$(NO_TOOLS_DEPS)' 'NO_TESTS_DEPS=$(NO_TESTS_DEPS)' 'NO_GATEWARE_UPLOAD=$(NO_GATEWARE_UPLOAD)' $(MAKECMDGOALS)
...
ifeq ($(strip $(VERBOSE)),1)
	...
	$(V)$(MAKE) --directory="$(DEPENDENCY_PATH_$*)" --file="$(DEPENDENCY_PATH_$*)/Makefile" $(MAKEFLAGS) $(DEPENDENCY_OPTS_$*) 'MAKE_INC_PATH=$(MAKE_INC_PATH)' 'MCU_TARGET=$*' 'BUILD_DIR=$(BUILD_DIR)/$*' 'OPTIMIZE=$(OPTIMIZE)' 'VERBOSE=$(VERBOSE)' 'DEBUG=$(DEBUG)' 'NO_GATEWARE_DEPS=$(NO_GATEWARE_DEPS)' 'NO_TOOLS_DEPS=$(NO_TOOLS_DEPS)' 'NO_TESTS_DEPS=$(NO_TESTS_DEPS)' 'NO_GATEWARE_UPLOAD=$(NO_GATEWARE_UPLOAD)' $(MAKECMDGOALS)
...
ifeq ($(strip $(VERBOSE)),1)
	...
	$(V)$(MAKE) --directory="$(DEPENDENCY_PATH_$*)" --file="$(DEPENDENCY_PATH_$*)/Makefile" $(MAKEFLAGS) $(DEPENDENCY_OPTS_$*) 'MAKE_INC_PATH=$(MAKE_INC_PATH)' 'MCU_TARGET=$*' 'BUILD_DIR=$(BUILD_DIR)/$*' 'VERBOSE=$(VERBOSE)' 'DEBUG=$(DEBUG)' 'NO_GATEWARE_DEPS=$(NO_GATEWARE_DEPS)' 'NO_TOOLS_DEPS=$(NO_TOOLS_DEPS)' 'NO_TESTS_DEPS=$(NO_TESTS_DEPS)' 'NO_GATEWARE_UPLOAD=$(NO_GATEWARE_UPLOAD)' $(MAKECMDGOALS)
