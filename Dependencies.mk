...
ifeq ($(strip $(VERBOSE)),1)
	...
	$(V)$(MAKE) --directory="$(DEPENDENCY_PATH_$*)" --file="$(DEPENDENCY_PATH_$*)/Makefile"	"MAKE_INC_PATH=$(MAKE_INC_PATH)" "MCU_TARGET=$*" "BUILD_DIR=$(BUILD_DIR)/$*" "VERBOSE=$(VERBOSE)" "DEBUG=$(DEBUG)" "NO_GATEWARE_DEPS=$(NO_GATEWARE_DEPS)" "NO_TOOLS_DEPS=$(NO_TOOLS_DEPS)" "NO_TESTS_DEPS=$(NO_TESTS_DEPS)" "NO_GATEWARE_UPLOAD=$(NO_GATEWARE_UPLOAD)" $(MAKEFLAGS) $(MAKECMDGOALS)
