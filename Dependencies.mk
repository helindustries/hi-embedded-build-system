...
ifeq ($(strip $(VERBOSE)),1)
	...
	$(V)$(MAKE) --directory="$(DEPENDENCY_PATH_$*)" --file="$(DEPENDENCY_PATH_$*)/Makefile" $(MAKEFLAGS) $(DEPENDENCY_OPTS_$*) 'MAKE_INC_PATH=$(MAKE_INC_PATH)' 'CPU_TARGET=$*' 'BUILD_DIR=$(BUILD_DIR)/$*' 'CPU_DEVICE=$(CPU_DEVICE)' 'CPU_EXEC_OFFSET=$(CPU_EXEC_OFFSET)' 'OPTIMIZE=$(OPTIMIZE)' 'VERBOSE=$(VERBOSE)' 'DEBUG=$(DEBUG)' 'CPU=$(CPU)' 'CPU_SPEED=$(CPU_SPEED)' 'BUS_SPEED=$(BUS_SPEED)' 'CPUARCH=$(CPUARCH)' 'CPU_CPPFLAGS=$(CPU_CPPFLAGS)' 'CPU_LDFLAGS=$(CPU_LDFLAGS)' 'SERIAL_ID=$(SERIAL_ID)' 'CPU_DEVICE_OPTS=$(CPU_DEVICE_OPTS)' 'CORE_LIB_PATH=$(CORE_LIB_PATH)' 'CORE_PATH=$(CORE_PATH)' 'NO_GATEWARE_DEPS=$(NO_GATEWARE_DEPS)' 'NO_TOOLS_DEPS=$(NO_TOOLS_DEPS)' 'NO_TESTS_DEPS=$(NO_TESTS_DEPS)' 'NO_GATEWARE_UPLOAD=$(NO_GATEWARE_UPLOAD)' $(MAKECMDGOALS)
...
ifeq ($(strip $(VERBOSE)),1)
	...
	$(V)$(MAKE) --directory="$(DEPENDENCY_PATH_$*)" --file="$(DEPENDENCY_PATH_$*)/Makefile" $(MAKEFLAGS) $(DEPENDENCY_OPTS_$*) 'MAKE_INC_PATH=$(MAKE_INC_PATH)' 'CPU_TARGET=$*' 'BUILD_DIR=$(BUILD_DIR)/$*' 'FPGA_DEVICE=$(FPGA_DEVICE)' 'VERBOSE=$(VERBOSE)' 'DEBUG=$(DEBUG)' 'NO_GATEWARE_UPLOAD=$(NO_GATEWARE_UPLOAD)' 'NO_GATEWARE_DEPS=$(NO_GATEWARE_DEPS)' 'NO_TOOLS_DEPS=$(NO_TOOLS_DEPS)' 'NO_TESTS_DEPS=$(NO_TESTS_DEPS)' 'NO_GATEWARE_UPLOAD=$(NO_GATEWARE_UPLOAD)' $(MAKECMDGOALS)
...
ifeq ($(strip $(VERBOSE)),1)
	...
	$(V)$(MAKE) --directory="$(DEPENDENCY_PATH_$*)" --file="$(DEPENDENCY_PATH_$*)/Makefile" $(MAKEFLAGS) $(DEPENDENCY_OPTS_$*) 'MAKE_INC_PATH=$(MAKE_INC_PATH)' 'CPU_TARGET=$*' 'BUILD_DIR=$(BUILD_DIR)/$*' 'OPTIMIZE=$(OPTIMIZE)' 'VERBOSE=$(VERBOSE)' 'DEBUG=$(DEBUG)' 'NO_GATEWARE_DEPS=$(NO_GATEWARE_DEPS)' 'NO_TOOLS_DEPS=$(NO_TOOLS_DEPS)' 'NO_TESTS_DEPS=$(NO_TESTS_DEPS)' 'NO_GATEWARE_UPLOAD=$(NO_GATEWARE_UPLOAD)' $(MAKECMDGOALS)
...
ifeq ($(strip $(VERBOSE)),1)
	...
	$(V)$(MAKE) --directory="$(DEPENDENCY_PATH_$*)" --file="$(DEPENDENCY_PATH_$*)/Makefile" $(MAKEFLAGS) $(DEPENDENCY_OPTS_$*) 'MAKE_INC_PATH=$(MAKE_INC_PATH)' 'CPU_TARGET=$*' 'BUILD_DIR=$(BUILD_DIR)/$*' 'VERBOSE=$(VERBOSE)' 'DEBUG=$(DEBUG)' 'NO_GATEWARE_DEPS=$(NO_GATEWARE_DEPS)' 'NO_TOOLS_DEPS=$(NO_TOOLS_DEPS)' 'NO_TESTS_DEPS=$(NO_TESTS_DEPS)' 'NO_GATEWARE_UPLOAD=$(NO_GATEWARE_UPLOAD)' $(MAKECMDGOALS)
